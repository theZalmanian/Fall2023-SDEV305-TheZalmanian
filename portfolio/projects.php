<?php 
    ...
    /**
     * Classes used by all SVG
     */
    $languageBadgeClasses = "language-badge p-2 m-2 rounded-4 border";

    /**
     * A collection of SVG badges representing programming languages:
     * C#, PHP, JavaScript, TypeScript, HTML, CSS, Kotlin, XML 
     */
    $languageBadges = array(
        "C#"            => "<svg class='{$languageBadgeClasses}' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
        ...
        , "PHP"         => "<svg class='{$languageBadgeClasses}' viewBox='0 0 32 32' xmlns='http://www.w3.org/2000/svg'>
        ...
        , "JavaScript"  => "<svg class='{$languageBadgeClasses}' viewBox='0 0 32 32' xmlns='http://www.w3.org/2000/svg'>
        ...
        , "TypeScript"  => "<svg class='{$languageBadgeClasses}' viewBox='0 0 32 32' xmlns='http://www.w3.org/2000/svg'>
        ...
        , "HTML"        => "<svg class='{$languageBadgeClasses}' viewBox='0 0 512 512' xmlns='http://www.w3.org/2000/svg'>
        ...
        , "CSS"         => "<svg class='{$languageBadgeClasses}' viewBox='0 0 512 512' xmlns='http://www.w3.org/2000/svg'>
        ...
        , "Kotlin"      => "<svg class='{$languageBadgeClasses}' viewBox='0 0 32 32' xmlns='http://www.w3.org/2000/svg'>
                                <path d='M1.734 32l15.068-15.333 15.198 15.333zM0 0h16l-16 16.667zM17.865 0l-17.865 18.667v13.333l32-32z'>
                                </path>
                            </svg>"
        , "XML"         => "<svg class='{$languageBadgeClasses}' viewBox='0 0 32 32' xmlns='http://www.w3.org/2000/svg'>
                                ...
                                <ul class="list-group list-group-flush px-3">
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex justify-content-center">
                                            <?php 
                                                echo $languageBadges["PHP"]; 
                                                echo $languageBadges["JavaScript"]; 
                                                echo $languageBadges["HTML"]; 
                                                echo $languageBadges["CSS"]; 
                                            ?>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <div class="accordion-body p-0">
                                <ul class="list-group list-group-flush px-3">
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex justify-content-center">
                                            <?php 
                                                echo $languageBadges["Kotlin"]; 
                                                echo $languageBadges["XML"]; 
                                            ?>                                            
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <div class="accordion-body p-0">
                                <ul class="list-group list-group-flush px-3">
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex justify-content-center">
                                            <?php 
                                                echo $languageBadges["TypeScript"]; 
                                                echo $languageBadges["JavaScript"]; 
                                                echo $languageBadges["HTML"]; 
                                                echo $languageBadges["CSS"]; 
                                            ?>
